# -----------------------------------------------------------------------------
# DEPS file for sparsehash-c11 scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# sparsehash-c11-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'sparsehash-c11': 'https://github.com/sparsehash/sparsehash-c11.git@{sparsehash-c11_revision}',
  # keep
  # this
  # line
}
